...
function Home() {
  ...
  return (
    <Container>
      ...
      <PageContainer>
        <ContentWrap>
          <Header primary="Hodl My Gullak" />
          <Row style={{ width: '100%', height: '30vh' }}>
              <h1 className="HeroUnderlay__Heading" style={{"transform": "matrix(1, 0, 0, 1, 0, 0)",
                                                             "fontSize":"96px",
                                                             "fontFamily": "Manrope,sans-serif",
                                                             "textAlign": "center" 
                                                            }}>
                <span className="HeroUnderlay__Heading__Word">Creat/Build.</span>
                <span className="HeroUnderlay__Heading__Word">Hold.</span>
                <span className="HeroUnderlay__Heading__Word">Earn.</span>
              </h1>
          </Row>
